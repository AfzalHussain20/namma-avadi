...
const dict = {
  ...
  leaderRameshAlt: {
    ...
    ta: 'ஆர். ரமேஷ் குமார் — ஆவடி, தமிழக வெற்றிக் கழகம்',
  },
  viewOfficialProfile: { en: 'View Official Profile →', ta: 'அதிகாரப்பூர்வ சுயவிவரம் →' },
  flagAlt: { en: 'Tamilaga Vettri Kazhagam official party flag', ta: 'தமிழக வெற்றிக் கழகத்தின் அதிகாரப்பூர்வ கொடி' },
